                ...
                <section className="form-container-2 sticky w-7-12" style={{top:10+"VH"}}>
                    ...
                    <div className="mb-3">
                      ...
                      <div className="mb-3">
                        ...
                        <input type="text" name="primaryContact" required autoComplete="off" id="exampleFormControlInput1"  value={this.state.primary_contact} onChange={this.handleInput} className="form-control input-1 border border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"/>
                      </div>
