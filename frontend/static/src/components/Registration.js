    ...
    return(
      <div class="form-container">
        <form class="form-2" onSubmit={this.handleSubmit}>
          ...
          <input class="input-1 ml-10 pb-10" type="tel" name="phone_number" align="center" placeholder="phone number" onChange={this.handleInput} value={this.state.phone_number} />
