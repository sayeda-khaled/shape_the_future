...
#
# from .views import EventListAPIView, EventDetailAPIView, VolunteerEventListAPIView, VolunteerEventDetailAPIView, StaffEventListAPIView, StaffEventDetailAPIView
#
# App_name = 'events'
#
# urlpatterns = [
